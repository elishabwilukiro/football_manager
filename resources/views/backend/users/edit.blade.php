                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-md-4 col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <input type="number" class="form-control" name="phone_number" id="phone_number" value="{{ old('phone_number', $user->phone_number ?? '') }}" placeholder="07..." required>
                                                  </div>
                                             </div>
                                             <div class="col-md-4 col-sm-12">
                                                  <div class="form-group">
                                                       <label>Location <span class="text-danger">*</span></label>
                                                       <input type="text" class="form-control" name="location" id="location" value="{{ old('location', $user->location ?? '') }}" placeholder="Chamazi, Dar es Salaam" required>
                                                  </div>
                                             </div>
                                             <div class="col-md-4 col-sm-12">
                                                  <div class="form-group">
                                             ...
                                             <div class="col-md-4 col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <select class="custom-select" name="role" id="role" required>
                                                            <option selected="">--Select--</option>
                                                            <option value="admin" {{ old('admin',$user->role == 'admin' ? 'selected' : '') }}>System Admin</option>
                                                            <option value="manager" {{ old('manager',$user->role == 'manager' ? 'selected' : '') }}>Team Manager</option>
                                                       </select>
                                                  </div>
                                             </div>
                                             <div class="col-md-4 col-sm-12">
